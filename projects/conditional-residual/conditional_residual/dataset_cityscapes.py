...
from conditional_residual.processing_cityscapes import EncodeSegmentationTree


TensorType = Union[Tensor, Image]
OutputType = Tuple[TensorType, TensorType, TensorType]


class Cityscapes(Dataset[OutputType], Sequence[OutputType]):
