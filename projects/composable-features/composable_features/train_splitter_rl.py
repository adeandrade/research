...
from composable_features.model_splitter import InformationSplitterPolicyGradients, Baseline
...
def train(
    ...
    logger = MLFlowLogger(tags={'model': InformationSplitterPolicyGradients.__name__, 'dataset': Cityscapes.__name__})
    ...
    model = InformationSplitterPolicyGradients(
