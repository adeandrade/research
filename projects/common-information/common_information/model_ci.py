...
class SharedCodec(Module):
    def __init__(
        ...
        self.encoder_a = model_lst.elic_lst_downsample(input_num_channels, latent_num_channels, num_blocks=3)
        self.encoder_b = model_lst.elic_lst_downsample(input_num_channels, latent_num_channels, num_blocks=3)

        self.decoder_a = model_lst.elic_lst_upsample(latent_num_channels, input_num_channels, num_blocks=3)
        self.decoder_b = model_lst.elic_lst_upsample(latent_num_channels, input_num_channels, num_blocks=3)
    ...
    def get_y(self, inputs: Tensor) -> tuple[tuple[Tensor, Tensor, Tensor], tuple[Tensor, Tensor]]:
        ...
        return (representations_a, representations_b, representations_common), (common_a, common_b)

    def forward(self, inputs: Tensor, masks: Tensor) -> tuple[tuple[Tensor, Tensor], AttributeDict[Tensor]]:
        (representations_a, representations_b, representations_common), (common_a, common_b) = self.get_y(inputs)
...
class JointCodec(Module):
    def __init__(
        ...
        self.encoder = model_lst.elic_lst_downsample(input_num_channels, latent_num_channels, num_blocks=3)
...
class SeparatedCodec(Module):
    def __init__(
        ...
        self.encoder_a = model_lst.elic_lst_downsample(input_num_channels, self.num_channels_block, num_blocks=3)
        self.encoder_b = model_lst.elic_lst_downsample(input_num_channels, self.num_channels_block, num_blocks=3)
        self.encoder_common = model_lst.elic_lst_downsample(input_num_channels, self.num_channels_block, num_blocks=3)
...
class CombinedCodec(Module):
    def __init__(
        ...
        self.encoder = model_lst.elic_lst_downsample(input_num_channels, 3 * self.num_channels_block, num_blocks=3)
