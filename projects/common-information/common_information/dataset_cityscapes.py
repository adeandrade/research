...
from common_information.processing_cityscapes import EncodeSegmentationTree


class Cityscapes[T](Dataset[T]):
    ...
    def __init__(
        self,
        path: str,
        transform: Callable[[Tuple[Image, Image, Image]], T],
        split: str = 'train',
    ) -> None:
    ...
    def __getitem__(self, index: int) -> T:
        ...
        with (
            self.file_fetcher.open_member(image_name) as image_file,
