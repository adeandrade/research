...
class MultimodalFaithfulnessTemplate:
    ...
    def generate_claims(excerpt):
        return (
            [
                textwrap.dedent(
                    """Based on the given excerpt, which contains text and possibly images, please generate a comprehensive list of FACTUAL, undisputed truths, that can inferred from the provided text and images.
