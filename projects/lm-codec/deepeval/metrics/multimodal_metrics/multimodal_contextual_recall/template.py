...
class MultimodalContextualRecallTemplate:
    ...
    def generate_verdicts(
        ...
        return (
            [
                textwrap.dedent(
                    """For EACH sentence and image in the given expected output below, determine whether the sentence or image can be attributed to the nodes of retrieval contexts. Please generate a list of JSON with two keys: `verdict` and `reason`.
